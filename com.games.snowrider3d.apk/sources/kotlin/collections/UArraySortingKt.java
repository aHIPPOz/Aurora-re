...
public final class UArraySortingKt {
    ...
    private static final int m756partition4UcCI2c(byte[] bArr, int i, int i2) {
        int i3;
        byte m380getw2LRezQ = UByteArray.m380getw2LRezQ(bArr, (i + i2) / 2);
        while (i <= i2) {
            while (true) {
                i3 = m380getw2LRezQ & 255;
            ...
            if (i <= i2) {
                byte m380getw2LRezQ2 = UByteArray.m380getw2LRezQ(bArr, i);
                UByteArray.m385setVurrAj0(bArr, i, UByteArray.m380getw2LRezQ(bArr, i2));
                UByteArray.m385setVurrAj0(bArr, i2, m380getw2LRezQ2);
                i++;
                i2--;
            }
        }
    ...
    private static final void m760quickSort4UcCI2c(byte[] bArr, int i, int i2) {
        int m756partition4UcCI2c = m756partition4UcCI2c(bArr, i, i2);
        int i3 = m756partition4UcCI2c - 1;
        if (i < i3) {
            m760quickSort4UcCI2c(bArr, i, i3);
        }
        if (m756partition4UcCI2c < i2) {
            m760quickSort4UcCI2c(bArr, m756partition4UcCI2c, i2);
        }
    }
    ...
    private static final int m757partitionAa5vz7o(short[] sArr, int i, int i2) {
        int i3;
        short m643getMh2AYeg = UShortArray.m643getMh2AYeg(sArr, (i + i2) / 2);
        while (i <= i2) {
            while (true) {
                int m643getMh2AYeg2 = UShortArray.m643getMh2AYeg(sArr, i) & UShort.MAX_VALUE;
                i3 = m643getMh2AYeg & UShort.MAX_VALUE;
                if (Intrinsics.compare(m643getMh2AYeg2, i3) < 0) {
                    i++;
                }
            }
            ...
            if (i <= i2) {
                short m643getMh2AYeg3 = UShortArray.m643getMh2AYeg(sArr, i);
                UShortArray.m648set01HTLdE(sArr, i, UShortArray.m643getMh2AYeg(sArr, i2));
                UShortArray.m648set01HTLdE(sArr, i2, m643getMh2AYeg3);
                i++;
                i2--;
            }
        }
    ...
    private static final void m761quickSortAa5vz7o(short[] sArr, int i, int i2) {
        int m757partitionAa5vz7o = m757partitionAa5vz7o(sArr, i, i2);
        int i3 = m757partitionAa5vz7o - 1;
        if (i < i3) {
            m761quickSortAa5vz7o(sArr, i, i3);
        }
        if (m757partitionAa5vz7o < i2) {
            m761quickSortAa5vz7o(sArr, m757partitionAa5vz7o, i2);
        }
    }
    ...
    */
    private static final int m758partitionoBK06Vg(int[] r3, int r4, int r5) {
        /*
            int r0 = r4 + r5
            int r0 = r0 / 2
            int r0 = kotlin.UIntArray.m459getpVg5ArA(r3, r0)
        L8:
            if (r4 > r5) goto L39
        La:
            int r1 = kotlin.UIntArray.m459getpVg5ArA(r3, r4)
            int r1 = kotlin.UByte$$ExternalSyntheticBackport0.m$2(r1, r0)
            if (r1 >= 0) goto L17
            int r4 = r4 + 1
            goto La
        L17:
            int r1 = kotlin.UIntArray.m459getpVg5ArA(r3, r5)
            int r1 = kotlin.UByte$$ExternalSyntheticBackport0.m$2(r1, r0)
            if (r1 <= 0) goto L24
            int r5 = r5 + (-1)
            goto L17
        L24:
            if (r4 > r5) goto L8
            int r1 = kotlin.UIntArray.m459getpVg5ArA(r3, r4)
            int r2 = kotlin.UIntArray.m459getpVg5ArA(r3, r5)
            kotlin.UIntArray.m464setVXSXFK8(r3, r4, r2)
            kotlin.UIntArray.m464setVXSXFK8(r3, r5, r1)
            int r4 = r4 + 1
            int r5 = r5 + (-1)
            goto L8
        L39:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.collections.UArraySortingKt.m758partitionoBK06Vg(int[], int, int):int");
    }

    /* renamed from: quickSort-oBK06Vg */
    private static final void m762quickSortoBK06Vg(int[] iArr, int i, int i2) {
        int m758partitionoBK06Vg = m758partitionoBK06Vg(iArr, i, i2);
        int i3 = m758partitionoBK06Vg - 1;
        if (i < i3) {
            m762quickSortoBK06Vg(iArr, i, i3);
        }
        if (m758partitionoBK06Vg < i2) {
            m762quickSortoBK06Vg(iArr, m758partitionoBK06Vg, i2);
        }
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static final int m755partitionnroSd4(long[] r6, int r7, int r8) {
        /*
            int r0 = r7 + r8
            int r0 = r0 / 2
            long r0 = kotlin.ULongArray.m538getsVKNKU(r6, r0)
        L8:
            if (r7 > r8) goto L39
        La:
            long r2 = kotlin.ULongArray.m538getsVKNKU(r6, r7)
            int r2 = kotlin.UByte$$ExternalSyntheticBackport0.m(r2, r0)
            if (r2 >= 0) goto L17
            int r7 = r7 + 1
            goto La
        L17:
            long r2 = kotlin.ULongArray.m538getsVKNKU(r6, r8)
            int r2 = kotlin.UByte$$ExternalSyntheticBackport0.m(r2, r0)
            if (r2 <= 0) goto L24
            int r8 = r8 + (-1)
            goto L17
        L24:
            if (r7 > r8) goto L8
            long r2 = kotlin.ULongArray.m538getsVKNKU(r6, r7)
            long r4 = kotlin.ULongArray.m538getsVKNKU(r6, r8)
            kotlin.ULongArray.m543setk8EXiF4(r6, r7, r4)
            kotlin.ULongArray.m543setk8EXiF4(r6, r8, r2)
            int r7 = r7 + 1
            int r8 = r8 + (-1)
            goto L8
        L39:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.collections.UArraySortingKt.m755partitionnroSd4(long[], int, int):int");
    }

    /* renamed from: quickSort--nroSd4 */
    private static final void m759quickSortnroSd4(long[] jArr, int i, int i2) {
        int m755partitionnroSd4 = m755partitionnroSd4(jArr, i, i2);
        int i3 = m755partitionnroSd4 - 1;
        if (i < i3) {
            m759quickSortnroSd4(jArr, i, i3);
        }
        if (m755partitionnroSd4 < i2) {
            m759quickSortnroSd4(jArr, m755partitionnroSd4, i2);
        }
    }
