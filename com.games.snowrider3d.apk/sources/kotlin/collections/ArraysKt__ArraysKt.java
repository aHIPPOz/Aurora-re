                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m872contentEqualslec5QzE(((ULongArray) t).m547unboximpl(), ((ULongArray) t2).m547unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m868contentEqualsKJPZfPQ(((UIntArray) t).m468unboximpl(), ((UIntArray) t2).m468unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m867contentEqualsFGO6Aew(((UShortArray) t).m652unboximpl(), ((UShortArray) t2).m652unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m870contentEqualskV0jMPg(((UByteArray) t).m389unboximpl(), ((UByteArray) t2).m389unboximpl())) {
                                                        return false;
                                                    }
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                if (t instanceof UByteArray) {
                    ...
                    if (uByteArray != null) {
                        bArr = uByteArray.m389unboximpl();
                    }
                    sb.append(UArraysKt.m884contentToString2csIQuQ(bArr));
                } else if (t instanceof UShortArray) {
                    UShortArray uShortArray = (UShortArray) t;
                    if (uShortArray != null) {
                        sArr = uShortArray.m652unboximpl();
                    }
                    sb.append(UArraysKt.m888contentToStringd6D3K8(sArr));
                } else if (t instanceof UIntArray) {
                    UIntArray uIntArray = (UIntArray) t;
                    if (uIntArray != null) {
                        iArr = uIntArray.m468unboximpl();
                    }
                    sb.append(UArraysKt.m887contentToStringXUkPCBk(iArr));
                } else if (t instanceof ULongArray) {
                    ULongArray uLongArray = (ULongArray) t;
                    if (uLongArray != null) {
                        jArr = uLongArray.m547unboximpl();
                    }
                    sb.append(UArraysKt.m890contentToStringuLth9ew(jArr));
                } else {
