...
public class UArraysKt___UArraysJvmKt {
    ...
    public static final int m771binarySearch2fe2U9s(int[] binarySearch, int i, int i2, int i3) {
        ...
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i2, i3, UIntArray.m460getSizeimpl(binarySearch));
        int i4 = i3 - 1;
        while (i2 <= i4) {
            int i5 = (i2 + i4) >>> 1;
    ...
    public static final int m775binarySearchK6DWlUc(long[] binarySearch, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, ULongArray.m539getSizeimpl(binarySearch));
        int i3 = i2 - 1;
        while (i <= i3) {
            int i4 = (i + i3) >>> 1;
    ...
    public static final int m777binarySearchWpHrYlw(byte[] binarySearch, byte b, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, UByteArray.m381getSizeimpl(binarySearch));
        int i3 = b & 255;
        int i4 = i2 - 1;
        while (i <= i4) {
            int i5 = (i + i4) >>> 1;
    ...
    public static final int m773binarySearchEtDCXyQ(short[] binarySearch, short s, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, UShortArray.m644getSizeimpl(binarySearch));
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UInt m789maxByjgv0xPQ(int[] maxBy, Function1<? super UInt, ? extends R> selector) {
        ...
        int m459getpVg5ArA = UIntArray.m459getpVg5ArA(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex == 0) {
            return UInt.m393boximpl(m459getpVg5ArA);
        }
        R invoke = selector.invoke(UInt.m393boximpl(m459getpVg5ArA));
        ?? it = new IntRange(1, lastIndex).iterator();
        while (it.hasNext()) {
            int m459getpVg5ArA2 = UIntArray.m459getpVg5ArA(maxBy, it.nextInt());
            R invoke2 = selector.invoke(UInt.m393boximpl(m459getpVg5ArA2));
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> ULong m788maxByMShoTSo(long[] maxBy, Function1<? super ULong, ? extends R> selector) {
        ...
        long m538getsVKNKU = ULongArray.m538getsVKNKU(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex == 0) {
            return ULong.m472boximpl(m538getsVKNKU);
        }
        R invoke = selector.invoke(ULong.m472boximpl(m538getsVKNKU));
        ?? it = new IntRange(1, lastIndex).iterator();
        while (it.hasNext()) {
            long m538getsVKNKU2 = ULongArray.m538getsVKNKU(maxBy, it.nextInt());
            R invoke2 = selector.invoke(ULong.m472boximpl(m538getsVKNKU2));
            if (invoke.compareTo(invoke2) < 0) {
                m538getsVKNKU = m538getsVKNKU2;
                invoke = invoke2;
            }
        }
        return ULong.m472boximpl(m538getsVKNKU);
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UByte m787maxByJOV_ifY(byte[] maxBy, Function1<? super UByte, ? extends R> selector) {
        ...
        byte m380getw2LRezQ = UByteArray.m380getw2LRezQ(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex == 0) {
            return UByte.m316boximpl(m380getw2LRezQ);
        }
        R invoke = selector.invoke(UByte.m316boximpl(m380getw2LRezQ));
        ?? it = new IntRange(1, lastIndex).iterator();
        while (it.hasNext()) {
            byte m380getw2LRezQ2 = UByteArray.m380getw2LRezQ(maxBy, it.nextInt());
            R invoke2 = selector.invoke(UByte.m316boximpl(m380getw2LRezQ2));
            if (invoke.compareTo(invoke2) < 0) {
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UShort m790maxByxTcfx_M(short[] maxBy, Function1<? super UShort, ? extends R> selector) {
        ...
        short m643getMh2AYeg = UShortArray.m643getMh2AYeg(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex == 0) {
            return UShort.m579boximpl(m643getMh2AYeg);
        }
        R invoke = selector.invoke(UShort.m579boximpl(m643getMh2AYeg));
        ?? it = new IntRange(1, lastIndex).iterator();
        while (it.hasNext()) {
            short m643getMh2AYeg2 = UShortArray.m643getMh2AYeg(maxBy, it.nextInt());
            R invoke2 = selector.invoke(UShort.m579boximpl(m643getMh2AYeg2));
            if (invoke.compareTo(invoke2) < 0) {
                m643getMh2AYeg = m643getMh2AYeg2;
                invoke = invoke2;
            }
        }
        return UShort.m579boximpl(m643getMh2AYeg);
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UInt m801minByjgv0xPQ(int[] minBy, Function1<? super UInt, ? extends R> selector) {
        ...
        int m459getpVg5ArA = UIntArray.m459getpVg5ArA(minBy, 0);
        ...
        ?? it = new IntRange(1, lastIndex).iterator();
        while (it.hasNext()) {
            int m459getpVg5ArA2 = UIntArray.m459getpVg5ArA(minBy, it.nextInt());
            R invoke2 = selector.invoke(UInt.m393boximpl(m459getpVg5ArA2));
            if (invoke.compareTo(invoke2) > 0) {
                m459getpVg5ArA = m459getpVg5ArA2;
                invoke = invoke2;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> ULong m800minByMShoTSo(long[] minBy, Function1<? super ULong, ? extends R> selector) {
        ...
        long m538getsVKNKU = ULongArray.m538getsVKNKU(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex == 0) {
            return ULong.m472boximpl(m538getsVKNKU);
        }
        ...
        ?? it = new IntRange(1, lastIndex).iterator();
        while (it.hasNext()) {
            long m538getsVKNKU2 = ULongArray.m538getsVKNKU(minBy, it.nextInt());
            R invoke2 = selector.invoke(ULong.m472boximpl(m538getsVKNKU2));
            if (invoke.compareTo(invoke2) > 0) {
                m538getsVKNKU = m538getsVKNKU2;
                invoke = invoke2;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UByte m799minByJOV_ifY(byte[] minBy, Function1<? super UByte, ? extends R> selector) {
        ...
        byte m380getw2LRezQ = UByteArray.m380getw2LRezQ(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex == 0) {
            return UByte.m316boximpl(m380getw2LRezQ);
        }
        ...
        ?? it = new IntRange(1, lastIndex).iterator();
        while (it.hasNext()) {
            byte m380getw2LRezQ2 = UByteArray.m380getw2LRezQ(minBy, it.nextInt());
            R invoke2 = selector.invoke(UByte.m316boximpl(m380getw2LRezQ2));
            if (invoke.compareTo(invoke2) > 0) {
                m380getw2LRezQ = m380getw2LRezQ2;
                invoke = invoke2;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UShort m802minByxTcfx_M(short[] minBy, Function1<? super UShort, ? extends R> selector) {
        ...
        short m643getMh2AYeg = UShortArray.m643getMh2AYeg(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex == 0) {
            return UShort.m579boximpl(m643getMh2AYeg);
        }
        ...
        ?? it = new IntRange(1, lastIndex).iterator();
        while (it.hasNext()) {
            short m643getMh2AYeg2 = UShortArray.m643getMh2AYeg(minBy, it.nextInt());
            R invoke2 = selector.invoke(UShort.m579boximpl(m643getMh2AYeg2));
            if (invoke.compareTo(invoke2) > 0) {
                m643getMh2AYeg = m643getMh2AYeg2;
                invoke = invoke2;
    ...
    private static final BigDecimal sumOfBigDecimal(int[] sumOf, Function1<? super UInt, ? extends BigDecimal> selector) {
        ...
        int m460getSizeimpl = UIntArray.m460getSizeimpl(sumOf);
        for (int i = 0; i < m460getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(UInt.m393boximpl(UIntArray.m459getpVg5ArA(sumOf, i))));
    ...
    private static final BigDecimal sumOfBigDecimal(long[] sumOf, Function1<? super ULong, ? extends BigDecimal> selector) {
        ...
        BigDecimal valueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        int m539getSizeimpl = ULongArray.m539getSizeimpl(sumOf);
        for (int i = 0; i < m539getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(ULong.m472boximpl(ULongArray.m538getsVKNKU(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(byte[] sumOf, Function1<? super UByte, ? extends BigDecimal> selector) {
        ...
        BigDecimal valueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        int m381getSizeimpl = UByteArray.m381getSizeimpl(sumOf);
        for (int i = 0; i < m381getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(UByte.m316boximpl(UByteArray.m380getw2LRezQ(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(short[] sumOf, Function1<? super UShort, ? extends BigDecimal> selector) {
        ...
        BigDecimal valueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        int m644getSizeimpl = UShortArray.m644getSizeimpl(sumOf);
        for (int i = 0; i < m644getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(UShort.m579boximpl(UShortArray.m643getMh2AYeg(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
