...
public class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final Byte toByteExactOrNull(int i) {
        if (new IntRange(RangingPosition.RSSI_UNKNOWN, WorkQueueKt.MASK).contains(i)) {
    ...
    public static final Byte toByteExactOrNull(short s) {
        if (RangesKt.intRangeContains((ClosedRange<Integer>) new IntRange(RangingPosition.RSSI_UNKNOWN, WorkQueueKt.MASK), s)) {
