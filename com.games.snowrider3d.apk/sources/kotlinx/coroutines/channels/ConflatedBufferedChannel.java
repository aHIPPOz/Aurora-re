...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m1817trySendImplMj0NB7M = conflatedBufferedChannel.m1817trySendImplMj0NB7M(e, true);
        if (m1817trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m1803exceptionOrNullimpl(m1817trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m1817trySendImplMj0NB7M = conflatedBufferedChannel.m1817trySendImplMj0NB7M(e, true);
        if (!(m1817trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) m1817trySendImplMj0NB7M;
    ...
    public Object mo1789trySendJP2dKIU(E e) {
        return m1817trySendImplMj0NB7M(e, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M */
    private final Object m1817trySendImplMj0NB7M(E e, boolean z) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m1815trySendDropLatestMj0NB7M(e, z) : m1816trySendDropOldestJP2dKIU(e);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M */
    private final Object m1815trySendDropLatestMj0NB7M(E e, boolean z) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo1789trySendJP2dKIU = super.mo1789trySendJP2dKIU(e);
        if (ChannelResult.m1809isSuccessimpl(mo1789trySendJP2dKIU) || ChannelResult.m1807isClosedimpl(mo1789trySendJP2dKIU)) {
            return mo1789trySendJP2dKIU;
        }
    ...
    private final Object m1816trySendDropOldestJP2dKIU(E e) {
    ...
    public void registerSelectForSend(SelectInstance<?> selectInstance, Object obj) {
        Object mo1789trySendJP2dKIU = mo1789trySendJP2dKIU(obj);
        if (!(mo1789trySendJP2dKIU instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) mo1789trySendJP2dKIU;
            selectInstance.selectInRegistrationPhase(Unit.INSTANCE);
        } else if (!(mo1789trySendJP2dKIU instanceof ChannelResult.Closed)) {
            throw new IllegalStateException("unreachable".toString());
        } else {
            ChannelResult.m1803exceptionOrNullimpl(mo1789trySendJP2dKIU);
