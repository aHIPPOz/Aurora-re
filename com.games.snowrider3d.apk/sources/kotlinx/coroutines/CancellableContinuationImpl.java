...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    private final Object resumedState(NotCompleted notCompleted, Object obj, int i, Function1<? super Throwable, Unit> function1, Object obj2) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return obj;
        } else if ((DispatchedTaskKt.isCancellableMode(i) || obj2 != null) && (function1 != null || (notCompleted instanceof CancelHandler) || obj2 != null)) {
    ...
    private final void resumeImpl(Object obj, int i, Function1<? super Throwable, Unit> function1) {
        ...
        while (true) {
            ...
            if (obj2 instanceof NotCompleted) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj2, resumedState((NotCompleted) obj2, obj3, i2, function12, null))) {
                    detachChildIfNonResuable();
                    dispatchResume(i2);
                    return;
                }
    ...
    private final Symbol tryResumeImpl(Object obj, Object obj2, Function1<? super Throwable, Unit> function1) {
        ...
        while (true) {
            ...
            if (obj3 instanceof NotCompleted) {
                ...
                Object obj5 = obj2;
                Function1<? super Throwable, Unit> function12 = function1;
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj3, resumedState((NotCompleted) obj3, obj4, this.resumeMode, function12, obj5))) {
                    detachChildIfNonResuable();
                ...
                Object obj6 = obj;
                Object obj7 = obj2;
                if ((obj3 instanceof CompletedContinuation) && obj7 != null) {
                    CompletedContinuation completedContinuation = (CompletedContinuation) obj3;
                    if (completedContinuation.idempotentResume == obj7) {
                        if (DebugKt.getASSERTIONS_ENABLED() && !Intrinsics.areEqual(completedContinuation.result, obj6)) {
                            throw new AssertionError();
                        }
                        return CancellableContinuationImplKt.RESUME_TOKEN;
                    }
