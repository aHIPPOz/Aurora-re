...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x006f, code lost:
        if (r4 >= com.google.common.util.concurrent.AbstractFuture.SPIN_THRESHOLD_NANOS) goto L23;
     */
    ...
    public boolean cancel(boolean z) {
        ...
        if ((obj2 == null) || (obj2 instanceof SetFuture)) {
            if (GENERATE_CANCELLATION_CAUSES) {
                obj = new Cancellation(z, new CancellationException("Future.cancel() was called."));
            } else {
                if (z) {
                ...
                obj = Objects.requireNonNull(cancellation);
            }
            AbstractFuture<V> abstractFuture = this;
            boolean z2 = false;
            while (true) {
                if (ATOMIC_HELPER.casValue(abstractFuture, obj2, obj)) {
                    if (z) {
