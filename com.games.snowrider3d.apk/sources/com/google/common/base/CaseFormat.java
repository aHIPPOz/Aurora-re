...
public enum CaseFormat {
    ...
    LOWER_CAMEL(CharMatcher.inRange('A', 'Z'), RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED) { // from class: com.google.common.base.CaseFormat.3
        @Override // com.google.common.base.CaseFormat
        String normalizeWord(String str) {
    ...
    UPPER_CAMEL(CharMatcher.inRange('A', 'Z'), RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED) { // from class: com.google.common.base.CaseFormat.4
        @Override // com.google.common.base.CaseFormat
        String normalizeWord(String str) {
            return CaseFormat.firstCharOnlyToUpper(str);
        }
