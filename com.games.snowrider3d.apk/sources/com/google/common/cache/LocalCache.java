    ...
    public static class Segment<K, V> extends ReentrantLock {
                ...
                while (true) {
                    ...
                    if (referenceEntry3.getHash() != i || key == null || !this.map.keyEquivalence.equivalent(k, key)) {
                        ...
                        if (v2 != null) {
                            ...
                            if (z) {
                                recordLockedRead(referenceEntry4, j2);
                                return v2;
                            }
                            this.modCount++;
                ...
                while (true) {
                    ...
                    if (referenceEntry3.getHash() != i2 || key == null || !this.map.keyEquivalence.equivalent(k, key)) {
                        ...
                        if (v3 == null) {
                            if (valueReference.isActive()) {
                                this.modCount++;
                                atomicReferenceArray.set(length, removeValueFromChain(referenceEntry, referenceEntry3, key, i2, v3, valueReference, RemovalCause.COLLECTED));
                                this.count--;
                            }
        ...
        */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:19:0x0058, code lost:
            if (r10.isActive() == false) goto L34;
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:24:0x0072, code lost:
            if (r11 != com.google.common.cache.RemovalCause.EXPLICIT) goto L25;
         */
