...
public final class AchievementEntity extends zzg implements Achievement {
    ...
    public static int zzd(Achievement achievement) {
        ...
        return Objects.hashCode(achievement.getAchievementId(), achievement.zza(), achievement.getName(), Integer.valueOf(achievement.getType()), achievement.getDescription(), Long.valueOf(achievement.getXpValue()), Integer.valueOf(achievement.getState()), Long.valueOf(achievement.getLastUpdatedTimestamp()), achievement.zzb(), Integer.valueOf(i2), Integer.valueOf(i));
    }
