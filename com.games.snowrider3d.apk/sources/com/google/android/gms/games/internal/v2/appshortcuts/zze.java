...
public final class zze extends zzf {
    ...
    public final /* synthetic */ void zzb() {
        ...
        if (zza == null || zza.zza() <= 0) {
            task = Tasks.forResult(zze(zzg, zzg2));
        } else {
            final zzq zzqVar = new zzq(context);
            task = zzqVar.doRead(TaskApiCall.builder().setMethodKey(6744).setFeatures(com.google.android.gms.games.zzd.zzg).setAutoResolveMissingFeatures(false).run(new RemoteCall() { // from class: com.google.android.gms.games.internal.v2.appshortcuts.zzp
                ...
                public final /* synthetic */ Object then(Task task2) {
                    return zze.zzc(zzhd.this, zzg2, task2);
                }
            });
        }
        task.addOnSuccessListener(zzio.zza(), new OnSuccessListener() { // from class: com.google.android.gms.games.internal.v2.appshortcuts.zzb
