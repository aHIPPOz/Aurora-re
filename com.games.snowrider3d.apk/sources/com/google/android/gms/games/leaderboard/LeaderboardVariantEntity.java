...
public final class LeaderboardVariantEntity implements LeaderboardVariant {
    ...
    public static String zzf(LeaderboardVariant leaderboardVariant) {
        ...
        return add2.add("DisplayPlayerRank", str2).add("NumScores", Long.valueOf(leaderboardVariant.getNumScores())).add("TopPageNextToken", leaderboardVariant.zza()).add("WindowPageNextToken", leaderboardVariant.zzc()).add("WindowPagePrevToken", leaderboardVariant.zzb()).toString();
    }
