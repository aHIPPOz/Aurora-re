...
public final class zzbg implements zzhgr {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        if (zzbkVar != null) {
            ...
            listenableFuture = zzgdn.zzh(zzbkVar);
        } else {
            listenableFuture = zzfhaVar.zzb(zzfgu.GENERATE_SIGNALS, zzb2.zzc()).zzf(zzb).zzi(((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbde.zzfS)).intValue(), TimeUnit.SECONDS).zza();
            zzgdn.zzr(listenableFuture, new zzaw(zzdesVar), zzcaf.zza);
        }
