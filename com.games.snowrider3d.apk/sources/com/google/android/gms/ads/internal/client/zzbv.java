...
public final class zzbv extends zzayt implements zzbx {
    ...
    public final zzco zzk() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            zzcoVar = queryLocalInterface instanceof zzco ? (zzco) queryLocalInterface : new zzcm(readStrongBinder);
        }
        zzda.recycle();
        return zzcoVar;
    }
    ...
    public final zzed zzm() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            zzedVar = queryLocalInterface instanceof zzed ? (zzed) queryLocalInterface : new zzeb(readStrongBinder);
        }
        zzda.recycle();
        return zzedVar;
    }
