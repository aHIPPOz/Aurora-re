...
final class zzin extends zzjf {
    ...
    public zzin(zzji zzjiVar, GoogleApiClient googleApiClient, String str, long j, ListenerHolder listenerHolder) {
    ...
    protected final /* bridge */ /* synthetic */ void doExecute(Api.AnyClient anyClient) throws RemoteException {
        ...
        zzmqVar.zzf(build);
        ((zzkd) ((zzgy) anyClient).getService()).zzk(zzmqVar.zzi());
    }
}
