...
public final class zzbvt {
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(13:2|(1:4)(1:5)|6|(1:8)|9|(3:31|14|(7:16|17|29|18|(1:20)|21|(2:25|26)(1:33)))|11|17|29|18|(0)|21|(1:34)(3:23|25|26)) */
    /* JADX WARN: Removed duplicated region for block: B:20:0x009a A[Catch: Exception -> 0x00b0, TRY_LEAVE, TryCatch #0 {Exception -> 0x00b0, blocks: (B:18:0x008c, B:20:0x009a), top: B:29:0x008c }] */
    /*
    ...
    */
    ...
    private final void zzd(Context context) {
        ...
        if (!((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbde.zzlv)).booleanValue() || Build.VERSION.SDK_INT < 33) {
            ...
            intent = context.registerReceiver(null, intentFilter, 4);
        }
        boolean z = false;
        if (intent == null) {
            this.zzm = -1.0d;
        ...
        this.zzm = intent.getIntExtra("level", -1) / intent.getIntExtra("scale", -1);
