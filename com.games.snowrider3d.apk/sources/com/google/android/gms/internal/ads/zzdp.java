...
public final class zzdp implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public final void zzb(int i) throws zzdq {
        ...
        if (i == 1) {
            ...
            zzdr.zza(eGLSurface != null, "eglCreatePbufferSurface failed");
        }
        zzdr.zza(EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, eglCreateContext), "eglMakeCurrent failed");
        this.zzf = eGLSurface;
        int[] iArr3 = this.zzc;
