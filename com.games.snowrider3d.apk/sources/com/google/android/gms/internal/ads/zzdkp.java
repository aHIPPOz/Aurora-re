...
public final class zzdkp {
    ...
    public static /* synthetic */ void zzc(zzdkp zzdkpVar, final View view, final WindowManager windowManager, zzcfg zzcfgVar, final Map map) {
        ...
        zzcfgVar.zzN().zzC(new zzcgw() { // from class: com.google.android.gms.internal.ads.zzdkn
            ...
            public final void zza(boolean z, int i2, String str, String str2) {
                zzdkp.zzd(zzdkp.this, map, z, i2, str, str2);
            }
        });
        if (map == null) {
            return;
