        ...
        switch (i) {
            ...
            case 5:
                ...
                if (zabqVar == null) {
                    ...
                    zabqVar.zaE(new Status(17, "Error resolution was canceled by the user, original error message: " + errorString + ": " + errorMessage));
                    break;
                } else {
                    apiKey = zabqVar.zad;
            ...
            case 9:
                ...
                break;
            case 10:
                for (ApiKey apiKey8 : this.zaq) {
                    zabq zabqVar6 = (zabq) this.zan.remove(apiKey8);
                    if (zabqVar6 != null) {
                        zabqVar6.zav();
                    }
                }
