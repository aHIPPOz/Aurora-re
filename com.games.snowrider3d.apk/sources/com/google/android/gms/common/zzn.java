    ...
    private static zzx zzi(String str, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        try {
            ...
            try {
                ...
                try {
                    if (z4) {
                        zzqVar = zze.zze(zzoVar);
                    } else {
                        zzqVar = zze.zzf(zzoVar);
                    }
                    if (zzqVar.zzb()) {
                        zzxVar = zzx.zzf(zzqVar.zzc());
                    } else {
                        String zza2 = zzqVar.zza();
                        ...
                        zzxVar = zzx.zzg(zzqVar.zzc(), zzqVar.zzd(), zza2, nameNotFoundException);
                    }
                } catch (RemoteException e) {
                    Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e);
                    zzxVar = zzx.zzd("module call", e);
                }
            } catch (DynamiteModule.LoadingException e2) {
                Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e2);
                zzxVar = zzx.zzd("module init: ".concat(String.valueOf(e2.getMessage())), e2);
            }
            return zzxVar;
        } finally {
            StrictMode.setThreadPolicy(allowThreadDiskReads);
