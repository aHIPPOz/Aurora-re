...
public abstract class AbstractC0112x implements TextWatcher {
    ...
    public abstract EditText createEditText(AbstractC0112x abstractC0112x);
    ...
    public AbstractC0112x(Context context, UnityPlayerForActivityOrService unityPlayerForActivityOrService) {
        this.a = context;
    ...
    public void invokeOnClose() {
        C0101r0 c0101r0 = this.g;
        if (c0101r0 != null) {
            RunnableC0103s0 runnableC0103s0 = c0101r0.a;
            runnableC0103s0.a = true;
            if (!runnableC0103s0.b) {
                return;
            }
    ...
    public void setupTextInput(String str, int i, boolean z, boolean z2, boolean z3, boolean z4, String str2, int i2) {
        this.c.setOnEditorActionListener(new C0110w(this));
