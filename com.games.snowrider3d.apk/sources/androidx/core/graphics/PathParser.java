        ...
        private static void addCommand(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            ...
            while (i4 < fArr2.length) {
                if (c2 == 'A') {
                    ...
                    drawArc(path, f27, f28, f29, f30, f31, f32, f33, z3, fArr2[i2 + 4] != f ? z : z2);
                    f19 = fArr2[i5];
                    f23 = f19;
                    f20 = fArr2[i6];
                    f24 = f20;
                    ...
                    int i9 = i2 + 4;
                    int i10 = i2 + 5;
                    path2.cubicTo(fArr2[i2], fArr2[i2 + 1], fArr2[i7], fArr2[i8], fArr2[i9], fArr2[i10]);
                    float f34 = fArr2[i9];
                    float f35 = fArr2[i10];
                    float f36 = fArr2[i7];
                    float f37 = fArr2[i8];
                    ...
                    if (c2 != 'Q') {
                        ...
                        if (c2 == 'V') {
                            ...
                            i2 = i4;
                            boolean z7 = fArr2[i4 + 4] != f6 ? z : z2;
                            float f50 = f23;
                            drawArc(path, f50, f5, f45, f46, f47, f48, f49, z4, z7);
                            f23 = f50 + fArr2[i28];
                            f24 = f5 + fArr2[i29];
                            f19 = f23;
                            f20 = f24;
                        ...
                        int i31 = i2 + 2;
                        int i32 = i2 + 3;
                        path2.quadTo(fArr2[i2], fArr2[i30], fArr2[i31], fArr2[i32]);
                        f3 = fArr2[i2];
                        f2 = fArr2[i30];
                        f23 = fArr2[i31];
                        f24 = fArr2[i32];
