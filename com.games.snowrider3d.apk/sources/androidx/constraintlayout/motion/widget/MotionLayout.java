...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public class Model {
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            if (constraintAnchor != null) {
                str2 = str5.concat(child.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? str5 : "B");
            } else {
                str2 = str6;
            }
            ...
            if (child.mLeft.mTarget != null) {
                str4 = str7.concat(child.mLeft.mTarget.mType == ConstraintAnchor.Type.LEFT ? str7 : "R");
            } else {
                str4 = str6;
            }
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str3 = "_";
                StringBuilder append = new StringBuilder().append(((constraintWidget.mTop.mTarget != null ? RequestConfiguration.MAX_AD_CONTENT_RATING_T : str3) + (constraintWidget.mBottom.mTarget != null ? "B" : str3)) + (constraintWidget.mLeft.mTarget != null ? "L" : str3));
    ...
    */
    ...
    public void getAnchorDpDt(int mTouchAnchorId, float pos, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        if (viewById == null) {
            str = RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED + mTouchAnchorId;
        } else {
