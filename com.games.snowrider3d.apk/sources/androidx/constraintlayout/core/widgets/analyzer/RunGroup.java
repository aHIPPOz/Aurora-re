...
public class RunGroup {
    ...
    public long computeWrapSize(ConstraintWidgetContainer constraintWidgetContainer, int i) {
        ...
        long j3 = ((-traverseEnd) - wrapDimension) - this.firstRun.start.margin;
        ...
        float f = (float) j;
        return (this.firstRun.start.margin + ((((f * biasPercent) + 0.5f) + wrapDimension) + ((f * (1.0f - biasPercent)) + 0.5f))) - this.firstRun.end.margin;
    }
