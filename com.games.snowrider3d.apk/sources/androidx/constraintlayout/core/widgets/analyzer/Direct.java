...
public class Direct {
    ...
    private static void horizontalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z) {
        ...
        if (anchor.getDependents() != null && anchor.hasFinalValue()) {
            ...
            while (it.hasNext()) {
                ...
                boolean z4 = ((next != constraintWidget2.mLeft || constraintWidget2.mRight.mTarget == null || !constraintWidget2.mRight.mTarget.hasFinalValue()) && (next != constraintWidget2.mRight || constraintWidget2.mLeft.mTarget == null || !constraintWidget2.mLeft.mTarget.hasFinalValue())) ? false : z2;
        ...
        if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
            ...
            while (it2.hasNext()) {
                ...
                boolean z6 = ((next2 != constraintWidget3.mLeft || constraintWidget3.mRight.mTarget == null || !constraintWidget3.mRight.mTarget.hasFinalValue()) && (next2 != constraintWidget3.mRight || constraintWidget3.mLeft.mTarget == null || !constraintWidget3.mLeft.mTarget.hasFinalValue())) ? false : z5;
    ...
    private static void verticalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer) {
        ...
        if (anchor.getDependents() != null && anchor.hasFinalValue()) {
            ...
            while (it.hasNext()) {
                ...
                boolean z2 = ((next != constraintWidget2.mTop || constraintWidget2.mBottom.mTarget == null || !constraintWidget2.mBottom.mTarget.hasFinalValue()) && (next != constraintWidget2.mBottom || constraintWidget2.mTop.mTarget == null || !constraintWidget2.mTop.mTarget.hasFinalValue())) ? false : z;
                boolean z3 = z;
        ...
        if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
            ...
            while (it2.hasNext()) {
                ...
                boolean z5 = ((next2 != constraintWidget3.mTop || constraintWidget3.mBottom.mTarget == null || !constraintWidget3.mBottom.mTarget.hasFinalValue()) && (next2 != constraintWidget3.mBottom || constraintWidget3.mTop.mTarget == null || !constraintWidget3.mTop.mTarget.hasFinalValue())) ? false : z4;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:99:0x01df, code lost:
        if (r5.mListAnchors[r23].mTarget.mOwner == r2) goto L101;
     */
