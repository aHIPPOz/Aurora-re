...
public class Motion implements TypedValues {
    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i2 < i) {
            ...
            if (keyCycleOscillator2 != null) {
                fArr[i3] = fArr[i3] + keyCycleOscillator2.get(f4);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            iArr6[i3] = 2;
            iArr6[0] = i7;
            double[][] dArr8 = (double[][]) Array.newInstance(Double.TYPE, iArr6);
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            while (true) {
                ...
                this.mStartMotionPath.customAttributes.get(this.mAttributeNames[i2 - 1]).setInterpolatedValue(motionWidget3, this.mValuesBuff);
                i2++;
            }
            if (this.mStartPoint.mVisibilityMode == 0) {
                if (f5 <= 0.0f) {
                    motionWidget3.setVisibility(this.mStartPoint.visibility);
                } else if (f5 >= 1.0f) {
                    motionWidget3.setVisibility(this.mEndPoint.visibility);
            ...
            motionWidget3.layout((int) f6, (int) f7, (int) (f6 + this.mStartMotionPath.width + ((this.mEndMotionPath.width - this.mStartMotionPath.width) * f5)), (int) (f7 + this.mStartMotionPath.height + ((this.mEndMotionPath.height - this.mStartMotionPath.height) * f5)));
        }
