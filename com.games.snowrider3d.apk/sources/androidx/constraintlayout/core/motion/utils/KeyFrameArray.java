...
public class KeyFrameArray {
    ...
    public static class CustomArray {
        ...
        public void dump() {
            ...
            int i = 0;
            while (i < this.count) {
                System.out.print((i == 0 ? RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED : ", ") + valueAt(i));
                i++;
            }
            System.out.println("]");
        }
    ...
    static class FloatArray {
        ...
        public void dump() {
            ...
            int i = 0;
            while (i < this.count) {
                System.out.print((i == 0 ? RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED : ", ") + Arrays.toString(valueAt(i)));
                i++;
            }
            System.out.println("]");
        }
