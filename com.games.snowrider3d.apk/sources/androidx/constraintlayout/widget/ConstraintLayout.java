        ...
        public final void measure(ConstraintWidget widget, BasicMeasure.Measure measure) {
            ...
            if (widget.getVisibility() == 8 && !widget.isInPlaceholder()) {
                ...
                if (i11 == 1) {
                    ...
                    i = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i10 + widget.getHorizontalMargin(), -1);
                } else if (i11 != 4) {
                    i = 0;
                } else {
                    i = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i10, -2);
                    ...
                    if (measure.measureStrategy == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                        ...
                        if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z || ((z && z2) || (view instanceof Placeholder) || widget.isResolvedHorizontally())) {
                            i = View.MeasureSpec.makeMeasureSpec(widget.getWidth(), 1073741824);
                        }
                    }
                }
                ...
                if (i12 == 1) {
                    ...
                    i2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i9 + widget.getVerticalMargin(), -1);
                } else if (i12 != 4) {
                    i2 = 0;
                } else {
                    i2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i9, -2);
                ...
                if (measure.measureStrategy == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z5 || widget.mMatchConstraintDefaultWidth != 0 || !z6 || widget.mMatchConstraintDefaultHeight != 0) {
                    ...
                    i3 = widget.mMatchConstraintMinHeight > 0 ? Math.max(widget.mMatchConstraintMinHeight, measuredHeight) : measuredHeight;
                    boolean z11 = z8;
                ...
                boolean z12 = i5 != i6 ? ConstraintLayout.USE_CONSTRAINTS_HELPER : false;
                ...
                if (z12 && i5 != -1 && widget.getBaselineDistance() != i5) {
