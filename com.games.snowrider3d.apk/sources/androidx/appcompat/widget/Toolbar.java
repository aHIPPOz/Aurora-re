...
public class Toolbar extends ViewGroup {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        iArr2[isLayoutRtl ? 1 : 0] = Math.max(0, currentContentInsetStart - i5);
        ...
        iArr2[i11] = Math.max(0, currentContentInsetEnd - i6);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i9 = Math.max(i9, measureChildCollapseMargins(this.mSubtitleTextView, i, i13 + i15, i2, i14 + i8, iArr));
        ...
        int paddingLeft = i13 + i9 + getPaddingLeft() + getPaddingRight();
    ...
    /* JADX WARN: Removed duplicated region for block: B:103:0x029c A[LOOP:0: B:102:0x029a->B:103:0x029c, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:106:0x02ba A[LOOP:1: B:105:0x02b8->B:106:0x02ba, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:109:0x02e2  */
    /* JADX WARN: Removed duplicated region for block: B:114:0x02f1 A[LOOP:2: B:113:0x02ef->B:114:0x02f1, LOOP_END] */
