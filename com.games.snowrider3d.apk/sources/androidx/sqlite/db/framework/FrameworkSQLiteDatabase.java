...
public class FrameworkSQLiteDatabase implements SupportSQLiteDatabase {
    ...
    public int delete(String str, String str2, Object[] objArr) {
        SupportSQLiteStatement compileStatement = compileStatement("DELETE FROM " + str + (TextUtils.isEmpty(str2) ? RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED : " WHERE " + str2));
